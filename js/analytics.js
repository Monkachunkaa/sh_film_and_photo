 ...
 * 
 * Usage:
 * import { trackEvent, trackFormSubmission, trackNavigation } from './analytics.js';
 * trackEvent('button_click', { button_name: 'Contact Us' });
 */
 ...
 */
export function trackFormSubmission(formType = 'contact', additionalParams = {}) {
 ...
 */
export function trackGalleryInteraction(galleryName, action, imageIndex = null) {
    const params = {
 ...
 */
export function trackVideoInteraction(action, videoTitle = '') {
 ...
 */
export function trackSlideshowInteraction(slideshowName, action) {
